...
// Import the new Neural Network Background!
...
export default function Home() {
  ...
  return (
    <div ref={container} className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 px-4 pointer-events-none z-10">
      ...
      {/* Ensure text stays above the canvas using relative and z-10 */}
      <div className="relative z-10 max-w-4xl text-center pointer-events-auto">
        
        <h2 className="hero-text text-5xl md:text-7xl font-extrabold tracking-tight mb-6 text-violet-900 dark:text-white transition-colors duration-500 drop-shadow-sm">
          Hi, I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-fuchsia-500 dark:from-violet-400 dark:to-fuchsia-400">Shubhampreet Singh</span>
        </h2>
        <p className="hero-text text-xl md:text-2xl text-violet-700 dark:text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed transition-colors duration-500 drop-shadow-sm">
          MCA Student & Developer specializing in MERN Stack & Machine Learning. Building scalable web apps and intelligent AI solutions.
        </p>
        ...
        <div className="flex justify-center gap-6">
          <Magnetic strength={0.3}>
            <a href="https://github.com/i-shubham24" target="_blank" rel="noreferrer" className="social-icon flex items-center justify-center w-14 h-14 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm hover:scale-110 hover:text-violet-700 dark:hover:text-violet-300 transition-all text-violet-500 dark:text-gray-400 border border-violet-100 dark:border-gray-700">
              <FiGithub size={24} />
            </a>
          </Magnetic>

          <Magnetic strength={0.3}>
            <a href="https://linkedin.com/in/shubhampreet-singh-12584824a" target="_blank" rel="noreferrer" className="social-icon flex items-center justify-center w-14 h-14 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm hover:scale-110 hover:text-violet-700 dark:hover:text-violet-300 transition-all text-violet-500 dark:text-gray-400 border border-violet-100 dark:border-gray-700">
              <FiLinkedin size={24} />
            </a>
          </Magnetic>

          <Magnetic strength={0.3}>
            <a href="https://instagram.com/shubh.ramgharia" target="_blank" rel="noreferrer" className="social-icon flex items-center justify-center w-14 h-14 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm hover:scale-110 hover:text-violet-700 dark:hover:text-violet-300 transition-all text-violet-500 dark:text-gray-400 border border-violet-100 dark:border-gray-700">
              <FiInstagram size={24} />
            </a>
          </Magnetic>
        </div>
