...
// import { Mail, Phone, MapPin, GraduationCap, Award, Calendar } from 'lucide-react';
...
//   const personalInfo = [
//     { icon: <Mail className="text-violet-600" size={20} />, label: "Email", value: "shubhamkaler24@gmail.com" },
//     { icon: <Phone className="text-violet-600" size={20} />, label: "Phone", value: "+91 9815272708" },
//     { icon: <MapPin className="text-violet-600" size={20} />, label: "Location", value: "Amritsar, Punjab" },
//     { icon: <GraduationCap className="text-violet-600" size={20} />, label: "Education", value: "MCA (2024-2026)" },
//     { icon: <Award className="text-violet-600" size={20} />, label: "CGPA", value: "8.00 / 10" },
//   ];
...
//       x: 50, opacity: 0, duration: 0.8, stagger: 0.2, ease: "power3.out", delay: 0.2 
//     });
...
//         scrollTrigger: {
//           trigger: bar,
//           start: "top 90%", // Triggers when the bar enters the viewport
//         }
//       });
//     });
//   }, { scope: container });
...
//           <h1 className="text-4xl md:text-5xl font-extrabold text-violet-900 mb-4 tracking-tight">Profile & Skills</h1>
...
//           <div className="lg:col-span-1 info-card h-fit bg-white/60 backdrop-blur-md rounded-3xl p-8 border border-violet-100 shadow-xl shadow-violet-100/50">
//             <div className="w-32 h-32 mx-auto bg-gradient-to-br from-violet-200 to-fuchsia-200 rounded-full mb-6 p-1 shadow-inner">
//               <div className="w-full h-full bg-white rounded-full flex items-center justify-center text-4xl font-bold text-violet-500">
//                 SS
//               </div>
//             </div>
//             <h2 className="text-2xl font-bold text-center text-violet-900 mb-2">Shubhampreet Singh</h2>
//             <p className="text-center text-violet-500 font-medium mb-8">Software & AI Developer</p>
            
//             <div className="space-y-6">
//               {personalInfo.map((info, idx) => (
//                 <div key={idx} className="flex items-center gap-4 border-b border-violet-50 pb-4 last:border-0">
//                   <div className="p-3 bg-violet-50 rounded-xl">
//                     {info.icon}
//                   </div>
//                   <div>
//                     <p className="text-xs text-violet-400 font-semibold uppercase tracking-wider">{info.label}</p>
//                     <p className="text-violet-900 font-medium">{info.value}</p>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//           {/* Right Column: Skill Fill Meters */}
//           <div className="lg:col-span-2 space-y-12">
            
//             {/* Tech Skills */}
//             <div className="skill-group bg-white/40 backdrop-blur-sm rounded-3xl p-8 border border-violet-50 shadow-lg shadow-violet-100/30">
//               <h3 className="text-2xl font-bold text-violet-900 mb-8 flex items-center gap-3">
...
//                       <span className="font-semibold text-violet-800">{skill.name}</span>
//                       <span className="text-violet-500 font-bold">{skill.level}%</span>
//                     </div>
...
// // Custom simple icons to keep the component clean
// function CodeIcon() {
//   return (
