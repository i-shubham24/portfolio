...
// import dermaImg from '../assets/ai-derma-concept.jpg';
// import marketplaceImg from '../assets/ai-marketplace-concept.jpg';
// import restaurantImg from '../assets/ai-restaurant-data.jpg';
...
// Image imports (ensure these match your exact file names in src/assets/images/)
import dermaImg from '../assets/ai-derma-concept.jpg';
import marketplaceImg from '../assets/ai-marketplace-concept.jpg';
import restaurantImg from '../assets/ai-restaurant-data.jpg';
...
export default function Projects() {
  ...
  // ** IMPORTANT: The keys here ("derma-ai") MUST match your GitHub repo names exactly **
  const projectDetails = {
    "derma-ai": {
      liveLink: "https://your-streamlit-app-link.streamlit.app",
      image: dermaImg, 
    ...
    <div className="min-h-screen pt-28 px-4 pb-16">
      <div className="max-w-6xl mx-auto" ref={galleryRef}>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {repos.map((repo) => {
               // This links the GitHub data to your custom descriptions and images
               const customDetails = projectDetails[repo.name] || {};
